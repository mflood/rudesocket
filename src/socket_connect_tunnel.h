...
#define INCLUDED_SOCKET_CONNECT_TUNNEL_H
...
//=
// Connects to its destination through a blind TCP Tunnel
//=
class Socket_Connect_Tunnel: public Socket_Connect{

protected:

	bool simpleConnect(SOCKET &s, const char *destip, int port);
